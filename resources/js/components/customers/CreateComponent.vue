            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h5 class="m-0 font-weight-bold text-primary">Add Customer Menu :</h5>
                        <router-link to="/dashboard/index-customer" class="btn btn-primary">
                            All Customers
                        </router-link>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="email" class="form-control"
                                            placeholder="Enter Customer Email Address" v-model="form.email" />
...
export default {
    ...
    methods:{
        ...
        {
            axios
                .post("/api/dashboard/customer", this.form)
                .then((res) => {
