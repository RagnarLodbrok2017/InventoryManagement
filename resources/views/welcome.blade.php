        ...
        <div id="wrapper">
            ...
            || $route.path === '/forget' ? false : true ">
                <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                    <router-link to="/" class="sidebar-brand d-flex align-items-center justify-content-center">
                        ...
                        <div class="sidebar-brand-text mx-3">Ortega</div>
                    </router-link>
                    ...
                    <li class="nav-item">
                        <a class="nav-link">
                            <i class="fas fa-fw fa-palette"></i>
                            <span>
                                <router-link to="/dashboard/index-product">Products</router-link>
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link">
                            <i class="fas fa-fw fa-palette"></i>
                            <span>
                                <router-link to="/dashboard/index-salary">Salaries</router-link>
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <!-- Container Fluid-->
                    <!-- ***************** Our Router View Part In Dashboard ***************** -->
